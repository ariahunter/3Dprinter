...
#define STRING_CONFIG_H_AUTHOR "ariahunter" // Who made the changes.
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 201.5 // mm

  // Horizontal offset from middle of printer to smooth rod center.
  #define DELTA_SMOOTH_ROD_OFFSET 153.5 // mm
  // Horizontal offset of the universal joints on the end effector.
  #define DELTA_EFFECTOR_OFFSET 34.4 // mm
  ...
  #define DELTA_HEIGHT 290 // get this value from auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 240 }  // default steps per unit for Kossel (GT2, 20 tooth)
...
#define Y_PROBE_OFFSET_FROM_EXTRUDER 0  // KosselPro actual: -6.304
/**
 * Kossel Pro note: The correct value is likely -17.45 but I'd rather err on the side of
 * not giving someone a head crash. Use something like G29 Z-0.2 to adjust as needed.
 */
#define Z_PROBE_OFFSET_FROM_EXTRUDER 0  // Increase this if the first layer is too thin (remember: it's a negative number so increase means closer to zero).
...
//#define Z_PROBE_ALLEN_KEY
  ...
  // Kossel Pro
  #define Z_PROBE_ALLEN_KEY_DEPLOY_1_X 30.0 // Move left but not quite so far that we'll bump the belt
  #define Z_PROBE_ALLEN_KEY_DEPLOY_1_Y DELTA_PRINTABLE_RADIUS
  #define Z_PROBE_ALLEN_KEY_DEPLOY_1_Z 100.0
  #define Z_PROBE_ALLEN_KEY_DEPLOY_1_FEEDRATE XY_PROBE_SPEED

  #define Z_PROBE_ALLEN_KEY_DEPLOY_2_X 0 // Move outward to position deploy pin to the left of the arm
  ...
  #define Z_PROBE_ALLEN_KEY_STOW_1_X -64.0 // Line up with bed retaining clip
  ...
  #define Z_PROBE_ALLEN_KEY_STOW_3_X Z_PROBE_ALLEN_KEY_STOW_1_X  // return to 0,0,100
